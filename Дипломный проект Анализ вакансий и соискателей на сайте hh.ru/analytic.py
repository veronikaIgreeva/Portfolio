...
class VacansySpider(CrawlSpider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='https://hh.ru/search/vacancy?st=searchVacancy&text=%D0%B0%D0%BD%D0%B0%D0%BB%D0%B8%D1%82%D0%B8%D0%BA&search_field=name&area=113&salary=&currency_code=RUR&experience=doesNotMatter&order_by=relevance&search_period=&items_on_page=50&no_magic=true&L_save_area=true', headers={
