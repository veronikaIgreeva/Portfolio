...
class VacansySpider(CrawlSpider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='https://hh.ru/search/vacancy?st=searchVacancy&text=Data+mining&area=113&salary=&currency_code=RUR&experience=doesNotMatter&order_by=relevance&search_period=&items_on_page=50&no_magic=true&L_save_area=true&from=suggest_post', headers={
