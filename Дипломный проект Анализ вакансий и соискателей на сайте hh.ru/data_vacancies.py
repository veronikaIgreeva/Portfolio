...
class VacansySpider(CrawlSpider):
    ...
    def start_requests(self):
        yield scrapy.Request(url='https://hh.ru/search/vacancy?L_is_autosearch=false&area=113&clusters=true&enable_snippets=true&items_on_page=50&no_magic=true&search_field=name&search_field=description&text=data&page=0', headers={
